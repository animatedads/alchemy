...
run "$REXX_BIN" test_base_dispatch_isolation.rex
...
run "$REXX_BIN" test_execution_provenance.rex
run "$REXX_BIN" test_cooperative_interposition.rex
...
run "$REXX_BIN" test_adoption_verifier.rex
run "$REXX_BIN" test_adoption_checkpoint.rex
