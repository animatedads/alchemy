...
ignore = obj~instrumentMethod("HELLO", .true)
say obj~hello
...
::method init
  ...
  meta["authorship"] = .array~of("Alchemy demo")
  meta["standards"] = .array~of("ALCHEMY-HOUSE-OBJECT-0.8")
  meta["design_limitations"] = .array~of("demonstration only")
