...
service=.LogService~new("logging-first-alchemy")
...
call assertEq "TELEMETRY_COORDINATED",r~code,"Alchemy recognizes active coordinator"
status=obj~methodInterpositionStatus("work")
...
say "PASS test_logging_first_alchemy"
exit 0
