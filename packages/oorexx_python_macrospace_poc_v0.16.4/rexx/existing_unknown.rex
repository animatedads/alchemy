...
::method installPythonProjection
  ...
  source = .array~of( -
    ...
    "if arg() <> 2 | \arg(1,'E') | \arg(2,'E') then return "!PYDISPATCH:unknown"", -
    "messageName = arg(1)", -
    "arguments = arg(2)", -
    "if \arguments~isA(.Array) then return "!PYDISPATCH:unknown"", -
    "if wordpos(messageName~upper, bridgePythonMethods) > 0 then do", -
    "  select", -
    "    when arguments~items == 0 then return "!PYDISPATCH:" || messageName", -
