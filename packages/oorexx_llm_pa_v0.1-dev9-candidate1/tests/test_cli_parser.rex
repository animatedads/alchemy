...
r = .LlmPaCliParser~parse('-machine "memory_status ed209e"')
call must r~ok, "machine parse"
call must r~value["command"] = "machine", "machine command"
call must r~value["arg1"] = "memory_status ed209e", "machine arguments"
