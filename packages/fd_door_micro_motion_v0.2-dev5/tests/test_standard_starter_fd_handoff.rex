...
i=.MigratableJobHandoffInstruction~new('FDH-1','FILE','MIG-FD-1','FD-HANDOFF-TEST',app~definitionRef,'tp-test','FDCK-1','NODE-A','PLACE-A',4,'NODE-B','PLACE-B',5,checkpoint,'sha256:state-digest','provider:verified','commit:fd-test','OOREXX','5.3-r13196','0.2-dev5',1000,'')
