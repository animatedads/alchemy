...
if st~get('placement_api','')<>'migratable.job.placement/1' | st~get('migratable_job_version','')<>'0.2.4' then call fail 'managed API/version status'
...
say 'PASS FD managed placement PLAN/ALLOCATE/CHECK/START/replay/RELEASE via v0.2.4 placement API'
exit 0
