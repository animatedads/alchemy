/* Safety10 pre-promotion live NR / And Register semantics. */
numeric digits 30
...
call truth m~executor~installLiveMethod('OP14',source),'install OP14'

call one 'FFFFFFFF','0F0F0F0F','0F0F0F0F',1
call one 'F0F0F0F0','0F0F0F0F','00000000',0
call one '80000000','FFFFFFFF','80000000',1

/* R1 == R2 must use the original register value and leave it unchanged. */
...
say 'PASS test_cpu_nr_live_trial'
exit 0
