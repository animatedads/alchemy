...
if log='' then log='/mnt/data/mvt_safety6_frontier.log'
...
call lineout log
if st<>'UNSUPPORTED' | d2x(ia,6)<>'016606' | m~cpu~instructionCount<>511776 | inst~left(2)<>'AF' then do
  say 'FAIL unexpected safety6 frontier'; exit 2
end
say 'PASS probe_mvt_safety6_frontier'
exit 0
