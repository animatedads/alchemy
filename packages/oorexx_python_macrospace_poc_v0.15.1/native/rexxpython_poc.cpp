...
static PyObject *release_python_object(PyObject *, PyObject *args)
{
    unsigned long long h;
    if (!PyArg_ParseTuple(args, "K", &h)) return nullptr;
    PyObject *object = reinterpret_cast<PyObject *>(static_cast<uintptr_t>(h));
    if (object != nullptr) Py_DECREF(object);
    Py_RETURN_NONE;
}

static PyObject *rexx_slots_to_python(PyObject *, PyObject *args)
{
    unsigned long long pyh; PyObject *omitted;
    if (!PyArg_ParseTuple(args, "KO", &pyh, &omitted)) return nullptr;
    PyObject *target = reinterpret_cast<PyObject *>(static_cast<uintptr_t>(pyh));
    if (target == nullptr) return PyErr_Format(PyExc_RuntimeError, "null Python receiver");

    // Deliberately model the four semantic cases that the Rexx-side sparse
    // argument experiment produces: omitted, .nil, empty string, value.
    Py_INCREF(omitted);
    PyObject *none = Py_None; Py_INCREF(none);
    PyObject *empty = PyUnicode_FromString("");
    PyObject *value = PyUnicode_FromString("hello");
    if (!empty || !value) {
        Py_DECREF(omitted); Py_DECREF(none);
        Py_XDECREF(empty); Py_XDECREF(value);
        return nullptr;
    }
    PyObject *result = PyObject_CallMethod(target, "receive_slots", "OOOO",
                                           omitted, none, empty, value);
    Py_DECREF(omitted); Py_DECREF(none); Py_DECREF(empty); Py_DECREF(value);
    return result;
}

static PyMethodDef methods[] = {
 {"create_animal", create_animal, METH_VARARGS, nullptr}, {"create_guarded", create_guarded, METH_VARARGS, nullptr}, {"create_argument_probe", create_argument_probe, METH_VARARGS, nullptr}, {"argument_probe_call", argument_probe_call, METH_VARARGS, nullptr}, {"create_stem", create_stem, METH_VARARGS, nullptr}, {"stem_get", stem_get, METH_VARARGS, nullptr}, {"stem_set", stem_set, METH_VARARGS, nullptr}, {"create_object_collection", create_object_collection, METH_VARARGS, nullptr}, {"wrap_python_object", wrap_python_object, METH_VARARGS, nullptr}, {"create_collection", create_collection, METH_VARARGS, nullptr},
 ...
 {"send2_index_string", send2_index_string, METH_VARARGS, nullptr}, {"send2_string_int", send2_string_int, METH_VARARGS, nullptr}, {"release_python_object", release_python_object, METH_VARARGS, nullptr}, {"release_handle", release_handle, METH_VARARGS, nullptr}, {"run_demo", run_demo, METH_VARARGS, nullptr},     {"retain_python_object", retain_python_object, METH_VARARGS, nullptr},
    {"release_python_object", release_python_object, METH_VARARGS, nullptr},
