...
if metadata['unitsVersion'] = .nil | metadata['unitsVersion'] = '' then call fail 'quantity metadata unitsVersion missing'
...
if failures = 0 then do
  say 'REXX-TRONICS UNITS DEV2-SURFACE COMPATIBILITY: OK'
