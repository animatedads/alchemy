...
static PyObject *rexx_slots_to_python(PyObject *, PyObject *args)
{
    ...
    PyObject *target = py_lookup(pyh);
    if (target == nullptr) return PyErr_Format(PyExc_KeyError, "unknown Python object handle");
