/* Demonstrate exactly nine bounded instructions from the real MTBOOT.EXB.
 * The ninth is indexed JRST fetched from AC17; then show the next core
 * instruction without executing it. */
numeric digits 30
parse arg tapePath
if tapePath = "" then do
  say "usage: rexx MTBootNineSteps.rex /path/to/bb-h137f-bm.tap"
  exit 2
end
