/* Demonstrate exactly seven bounded instructions from the real MTBOOT.EXB,
 * then show the decoded instruction at 040010 without executing it. */
numeric digits 30
parse arg tapePath
if tapePath = "" then do
  say "usage: rexx MTBootSevenSteps.rex /path/to/bb-h137f-bm.tap"
  exit 2
end
