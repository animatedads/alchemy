/* Demonstrate exactly ten bounded instructions from the real MTBOOT.EXB.
 * The tenth is SUBI 16,11; then show the next core instruction without executing it. */
numeric digits 30
parse arg tapePath
if tapePath = "" then do
  say "usage: rexx MTBootTenSteps.rex /path/to/bb-h137f-bm.tap"
  exit 2
end
