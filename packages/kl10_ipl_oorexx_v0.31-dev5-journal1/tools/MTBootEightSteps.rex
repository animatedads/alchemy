/* Demonstrate exactly eight bounded instructions from the real MTBOOT.EXB.
 * The eighth is JSP 16,17; then show the instruction fetched from AC17 without
 * executing it. */
numeric digits 30
parse arg tapePath
if tapePath = "" then do
  say "usage: rexx MTBootEightSteps.rex /path/to/bb-h137f-bm.tap"
  exit 2
end
...
say "next word from AC17, not executed:" oct18(cpu~pc) oct36(nextWord)
