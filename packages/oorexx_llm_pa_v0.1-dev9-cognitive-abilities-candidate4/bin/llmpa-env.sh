...
pa_path="$pa_root/src"
pa_path="$pa_path:$pa_root/deps/oorexx_cognitive_continuity_v0.1-dev2-exp1/src"
pa_path="$pa_path:$pa_root/deps/oorexx_cognitive_continuity_v0.1-dev2-exp1/integration"
