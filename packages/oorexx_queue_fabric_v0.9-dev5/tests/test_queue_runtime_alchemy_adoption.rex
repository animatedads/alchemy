/*
 * v0.9-dev5 staged AlchemyObject adoption.
 *
...
if .QueueFabricDevelopmentBuild~VERSION \= "0.9-dev5" then call fail "development package identity"

say "OBJECT QUEUE FABRIC V0.9-dev5 RUNTIME ALCHEMY OBJECT ADOPTION: OK"
exit 0
