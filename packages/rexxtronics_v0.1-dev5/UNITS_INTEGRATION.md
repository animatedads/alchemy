...
`oorexx_units_v0.1-dev2` owns dimensions, unit definitions, canonicalisation, conversion evidence, quantity metadata and unit parsing. Rexx-tronics owns circuit topology and electrical laws. Rexx-tronics must not grow a second unit catalogue or duplicate conversion constants.
...
## Units dev2 changes relevant to Rexx-tronics
...
Where the Units dev2 parser recognizes a unit token, Rexx-tronics typed boundaries accept text such as:
