...
main:
  say "RUNTIME REGISTRY SHARED CRYPTO KNOWN-ANSWER START"

  /* RFC 8032 Ed25519 test vector 1: empty message.  This is an external
   * known-answer vector, not a sign-and-verify round trip using this code. */
  ...
  say "RUNTIME REGISTRY SHARED CRYPTO KNOWN-ANSWER: OK"
  return
