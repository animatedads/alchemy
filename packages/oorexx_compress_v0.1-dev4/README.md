...
compressor, system compression library, compiler, or Foreign Runtime. dev4 also
...
- bounded raw-DEFLATE decoding with a live maximum-output ceiling for archive/package consumers.
