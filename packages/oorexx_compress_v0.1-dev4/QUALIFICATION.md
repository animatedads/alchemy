...
## dev4 bounded DEFLATE

Required native qualification proves an exact output limit succeeds and a one-byte-smaller limit fails closed before the decoder can append beyond the ceiling.
