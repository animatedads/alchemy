...
main:
  procedure
  use arg root
  say "GROK RUNTIME MODULE V0.4 START"
  ...
  call value "AI_GROK_MODELS", "fixture-model, second-model", "ENVIRONMENT"
  call value "AI_GROK_TIMEOUT", "5", "ENVIRONMENT"
  call value "AI_GROK_MAX_OUTPUT", "32", "ENVIRONMENT"
  call value "AI_GROK_CURL", root || "/tests/fixtures/fake_curl.sh", "ENVIRONMENT"
  call value "AI_GROK_ALLOW_HTTP_TEST", "1", "ENVIRONMENT"

  module = .GrokRuntimeModule~new
  ...
  say "GROK RUNTIME MODULE V0.4: OK"
  return
