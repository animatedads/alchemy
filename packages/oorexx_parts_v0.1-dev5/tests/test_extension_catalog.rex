...
if ss~parameter('HEAD_SHEAR_CAPACITY_N') = al~parameter('HEAD_SHEAR_CAPACITY_N') then call fail 'head shear material selection'
if st~parameter('HEAD_SHEAR_CAPACITY_N') <= ss~parameter('HEAD_SHEAR_CAPACITY_N') then call fail 'head shear steel reference'
if ss~parameter('HEAD_SHEAR_CAPACITY_N') <= 0 then call fail 'head shear capacity'
