...
/* Strict framing: TRUNCATEH is protocol + op + handle + size, no extras. */
r=rpc(d,"TRUNCATEH",enc("missing"),0,enc("unexpected"))
call assertEq rpcField(r,2),.StorageFuseErrno~EINVAL,"TRUNCATEH rejects extra field"
