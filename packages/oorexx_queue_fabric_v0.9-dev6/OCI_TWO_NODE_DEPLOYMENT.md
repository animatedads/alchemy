# Queue Fabric v0.9-dev6 — two-node OCI deployment pattern
...
The v0.9-dev6 compatibility constructor still accepts `keyHex` directly; secret-reference-native registration/rotation is intentionally a later integration increment rather than a second secret authority inside Queue Fabric.
