# ooRexx Pharo Alchemy v0.1-dev10-native-ffi
...
## dev10 — first live native crossing
Pharo 12 now loads and calls a shared library containing the real Alchemy native
lifecycle core. The executed path is Pharo -> FFI -> generation-tagged registry
-> pinned dispatch -> native result -> Pharo, with 41 -> 42.
