...
for demo in object_demo.py reversal_demo.py mixed_collection_demo.py unknown_demo.py arguments_return_object_demo.py profile_demo.py demo.py; do
    echo "== $demo =="
    "$PYTHON" "$ROOT/python/$demo"
done

echo "ALL v0.9 POC TESTS PASS"
