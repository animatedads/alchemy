parse arg out
if out='' then out='cylindrical_market_graph.png'
...
schema=.MLCylindricalTemporalPatternSchema~new(policy,'MARKET-GRAPH-MPL/1')
...
r=.MLGraphRenderers~byName('MATPLOTLIB'); g~render(r,out)
say 'A/B dominant='d~dominantDelta 'kind='d~dominantKind 'channel='d~dominantChannel 'total='d~totalDelta
say 'PNG' out 'renderer='r~name 'version='r~version
say 'PASS cylindrical_market_graph_matplotlib'
