...
MATERIALS=${OOREXX_MATERIALS_ROOT:-"$HERE/../oorexx_materials_v0.1-dev5"}
...
rexx test_motion_manufacturing.rex
...
rexx test_assemblies.rex

rexx test_manufactured_projection.rex

rexx test_rugby_ball.rex

rexx test_grok_dev5_extension.rex

rexx test_dev8_merge_coverage.rex

rexx test_laser_parts.rex

rexx test_rollup_test_family_catalog.rex
