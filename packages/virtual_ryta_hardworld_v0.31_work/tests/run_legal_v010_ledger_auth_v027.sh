...
export REXX_PATH="$ROOT:$ROOT/algorithm:$ROOT/integration:$LEGAL_EFFECT_ROOT/src:$LEGAL_EFFECT_ROOT/tests:$RUNTIME_REGISTRY_ROOT/src:$QUEUE_FABRIC_ROOT/src:$ALCHEMY_OBJECTS_ROOT/src:$CRYPTO_SRC_ROOT:$(dirname "$REXX")${REXX_PATH:+:$REXX_PATH}"
cd "$HERE"
"$REXX" test_legal_v010_ledger_auth_v027.rex
