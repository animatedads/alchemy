say 'RYTA ALCHEMY V0.8 ADOPTION V0.29 START'
ring = .CryptoMacKeyRing~new
ring~addKey('ryta-v029-adoption', '00112233445566778899aabbccddeeff')
...
call AssertEqual '0.29-work', metadata['PACKAGE_VERSION'], 'RYTA package version metadata'
...
say 'RYTA ALCHEMY V0.8 ADOPTION V0.29: OK'
exit 0
::routine AssertTrue
