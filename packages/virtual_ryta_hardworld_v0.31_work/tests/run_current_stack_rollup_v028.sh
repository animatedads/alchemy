...
printf '%s\n' '=== v0.28 Alchemy v0.7 preferred adoption ==='
cd "$HERE"; "$REXX" test_alchemy_v07_adoption_v028.rex
printf '%s\n' '=== v0.28 Legal reducer guard ==='
...
printf '%s\n' '=== v0.28 native live Legal authority compatibility ==='
...
printf '%s\n' '=== v0.28 legacy Legal promotion -> NoSQL ==='
...
printf '%s\n' '=== v0.28 retained-authority compatibility ==='
QUEUE_FABRIC_ROOT="$QUEUE_FABRIC_ROOT" "$HERE/run_retained_authority_v025.sh"
printf '%s\n' '=== v0.28 Legal retained consumer-time compatibility ==='
...
printf '%s\n' '=== v0.28 authenticated ledger adversaries ==='
QUEUE_FABRIC_ROOT="$QUEUE_FABRIC_ROOT" "$HERE/run_queue_authority_ledger_auth_v027.sh"
printf '%s\n' '=== v0.28 authenticated Legal completed-work recovery ==='
...
printf '%s\n' 'CURRENT STACK ROLL-UP V0.28-WORK: OK'
