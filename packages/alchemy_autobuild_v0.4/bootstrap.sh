...
[Service]
Type=simple
ExecStart=/usr/bin/python3 $REPO/packages/alchemy_autobuild_v0.4/alchemy_autobuild.py --config $ROOT/config.json
Restart=on-failure
RestartSec=2
...
EOF
printf '%s\n' "Installed Alchemy Autobuild v0.4 service definition"
