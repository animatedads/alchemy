...
[[ -f "$OVERLAY_ROOT/README_V02_HEADER.md" ]]
[[ -f "$OVERLAY_ROOT/CHANGELOG_V02_ENTRY.md" ]]
[[ -f "$OVERLAY_ROOT/test_reputation_communication_surface_smoke.rex" ]]
[[ -f "$OVERLAY_ROOT/AUTOBUILD_PROVENANCE.md" ]]
...
echo 'PASS PREPARE_REPUTATION_EFFECT_V02_R2'
