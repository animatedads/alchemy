...
call assertEq "EXECUTION_DIVERGENCE",verification~resultState,"wrong-way actual object is retained as top-level execution divergence"
call assertEq "WRONG_WAY_EXECUTION",verification~divergenceReason,"diagnostic reason identifies opposite-direction execution"
call assertEq 1,verification~wrongWayStepCount,"wrong-way step is machine-readable"
