...
if hands = "" then hands = 1000
if root = "" then root = "/tmp/psychic-poker-v06-batch-db"
...
say "CAMPAIGN hands=" || hands || " tournaments=" || tournaments
say ""
...
say ""
say "=== CURRENT TOURNAMENT LIVE + CAMPAIGN HISTORY FEDERATED JOIN ==="
