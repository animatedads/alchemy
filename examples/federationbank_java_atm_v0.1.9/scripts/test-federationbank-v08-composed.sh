...
: "${FB_BANK_ROOT:?set FB_BANK_ROOT to FederationBank v0.8 or the compat1 derivative}"
: "${JMS_BRIDGE_ROOT:?set JMS_BRIDGE_ROOT to oorexx_jms_queue_bridge_v0.1-dev7-fb1 candidate}"
...
FB_TEST_QUEUE_ROOT="$qroot" rexx "$ROOT/integration/oorexx/test_federationbank_queue_roundtrip.rex"
